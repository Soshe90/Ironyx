...
CURATION: list[Pick] = [
    ...
    Pick("Side Lateral Raise", "horizontalPush", "Lateral Raise"),
    Pick("Seated Side Lateral Raise", "horizontalPush"),
    Pick("Cable Seated Lateral Raise", "horizontalPush", "Cable Lateral Raise"),
    Pick("Front Dumbbell Raise", "horizontalPush"),
    Pick("Reverse Flyes", "horizontalPull", "Rear Delt Fly (Bent-Over Dumbbell)"),
    Pick("Reverse Machine Flyes", "horizontalPull", "Rear Delt Fly (Machine)"),
    Pick("Cable Rear Delt Fly", "horizontalPull"),
    Pick("Face Pull", "horizontalPull"),
    ...
    Pick("Lateral Raise - With Bands", "horizontalPush"),
    Pick("Front Cable Raise", "horizontalPush"),
    Pick("Dumbbell Scaption", "horizontalPush"),
    Pick("External Rotation with Band", "other"),
    Pick("Cable Internal Rotation", "other"),
    Pick("Cuban Press", "verticalPush"),
    # -- Arms: biceps -----------------------------------------------------
    Pick("Barbell Curl", "horizontalPull"),
    Pick("EZ-Bar Curl", "horizontalPull"),
    Pick("Dumbbell Bicep Curl", "horizontalPull", "Dumbbell Curl"),
    Pick("Incline Dumbbell Curl", "horizontalPull"),
    Pick("Hammer Curls", "horizontalPull", "Hammer Curl"),
    Pick("Cable Hammer Curls - Rope Attachment", "horizontalPull"),
    Pick("Concentration Curls", "horizontalPull", "Concentration Curl"),
    Pick("Preacher Curl", "horizontalPull"),
    Pick("Standing Biceps Cable Curl", "horizontalPull"),
    Pick("Reverse Barbell Curl", "horizontalPull", "Reverse Curl"),
    Pick("Zottman Curl", "horizontalPull"),
    Pick("Spider Curl", "horizontalPull"),
    Pick("Alternate Hammer Curl", "horizontalPull"),
    Pick("Cross Body Hammer Curl", "horizontalPull"),
    Pick("Drag Curl", "horizontalPull"),
    Pick("High Cable Curls", "horizontalPull"),
    Pick("Cable Preacher Curl", "horizontalPull"),
    Pick("Machine Bicep Curl", "horizontalPull"),
    Pick("Preacher Hammer Dumbbell Curl", "horizontalPull"),
    Pick("Seated Dumbbell Curl", "horizontalPull"),
    Pick("Standing Concentration Curl", "horizontalPull"),
    Pick("Two-Arm Dumbbell Preacher Curl", "horizontalPull"),
    # -- Arms: triceps ----------------------------------------------------
    Pick("Triceps Pushdown - Rope Attachment", "horizontalPush", "Tricep Pushdown"),
    Pick("Triceps Pushdown - V-Bar Attachment", "horizontalPush"),
    Pick("Close-Grip Barbell Bench Press", "horizontalPush", "Close-Grip Bench Press"),
    Pick("EZ-Bar Skullcrusher", "horizontalPush", "Skull Crusher"),
    Pick("Cable Rope Overhead Triceps Extension", "verticalPush", "Overhead Tricep Extension"),
    Pick("Seated Triceps Press", "verticalPush"),
    Pick("Tricep Dumbbell Kickback", "horizontalPush"),
    Pick("Dips - Triceps Version", "horizontalPush", "Tricep Dip"),
    Pick("Bench Dips", "horizontalPush"),
    Pick("Machine Triceps Extension", "horizontalPush"),
    Pick("Band Skull Crusher", "horizontalPush"),
    Pick("Cable Incline Triceps Extension", "horizontalPush"),
    Pick("Cable One Arm Tricep Extension", "horizontalPush"),
    Pick("Dip Machine", "horizontalPush"),
    Pick("JM Press", "horizontalPush"),
    Pick("Lying Dumbbell Tricep Extension", "horizontalPush"),
    Pick("Reverse Grip Triceps Pushdown", "horizontalPush"),
    Pick("Tate Press", "horizontalPush"),
    # -- Legs -------------------------------------------------------------
    ...
    # -- Core -------------------------------------------------------------
    Pick("Plank", "antiRotation", is_time_based=True),
    Pick("Side Bridge", "antiRotation", "Side Plank", is_time_based=True),
    ...
    # -- Calves -----------------------------------------------------------
    Pick("Standing Calf Raises", "kneeDominant", "Calf Raise"),
    Pick("Seated Calf Raise", "kneeDominant"),
    Pick("Standing Barbell Calf Raise", "kneeDominant", "Standing Calf Raise (Barbell)"),
    Pick("Calf Press On The Leg Press Machine", "kneeDominant"),
    Pick("Donkey Calf Raises", "kneeDominant"),
    Pick("Standing Dumbbell Calf Raise", "kneeDominant"),
    # -- Traps ------------------------------------------------------------
        ...
        exercises.append(
            {
                ...
                "isTimeBased": pick.is_time_based,
                "muscles": muscles,
